...
declare module "typescript" {
    ...
    const enum SyntaxKind {
        ...
        letiableDeclaration = 209,
        letiableDeclarationList = 210,
    ...
    interface letiableDeclaration extends Declaration {
        parent?: letiableDeclarationList;
        name: Identifier | BindingPattern;
        type?: TypeNode;
        initializer?: Expression;
    }
    interface letiableDeclarationList extends Node {
        declarations: NodeArray<letiableDeclaration>;
    }
    ...
    interface letiableLikeDeclaration extends Declaration {
        propertyName?: Identifier;
        dotDotDotToken?: Node;
        name: DeclarationName;
        questionToken?: Node;
    ...
    interface letiableStatement extends Statement {
        declarationList: letiableDeclarationList;
    }
    ...
    interface ForStatement extends IterationStatement {
        initializer?: letiableDeclarationList | Expression;
        condition?: Expression;
    ...
    interface CatchClause extends Node {
        letiableDeclaration: letiableDeclaration;
        block: Block;
    }
    ...
    interface JSDocletiadicType extends JSDocType {
        type: JSDocType;
    }
    ...
    interface SourceFile extends Declaration {
        ...
        languageletiant: Languageletiant;
        /**
    ...
    const enum SymbolFlags {
        None = 0,
        FunctionScopedletiable = 1,
        BlockScopedletiable = 2,
        Property = 4,
        EnumMember = 8,
        Function = 16,
        Class = 32,
        ...
        Module = 1536,
        Accessor = 98304,
        FunctionScopedletiableExcludes = 107454,
        BlockScopedletiableExcludes = 107455,
...
declare module "typescript" {
    ...
    interface Scanner {
        ...
        setLanguageletiant(letiant: Languageletiant): void;
    ...
    function createScanner(languageVersion: ScriptTarget, skipTrivia: boolean, languageletiant?: Languageletiant, text?: string, onError?: ErrorCallback, start?: number, length?: number): Scanner;
}
declare module "typescript" {
...
declare module "typescript" {
    ...
    module ScriptElementKind {
        ...
        const letiableElement: string;
        const localletiableElement: string;
        ...
        const memberletiableElement: string;
